...
@Component({
    selector: 'temp-app-relationship',
    templateUrl: './temp.relationship.component.html',
    styleUrls: ['./temp.relationship.component.css', '../../../ocs.component.css']
})
export class TempRelationshipComponent implements OnInit { assetId:any;
  ...
  ngOnInit(){
    ...
    this.ocsService.getTempRelationShip(this.assetId, resp=>{
